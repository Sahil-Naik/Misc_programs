...
void cmplx(float num, float imagi)
{
    ...
    cout<<"Given complex number is : "<<real(mycomplex)<<" + "<<imag(mycomplex)<<"i\n";
}
...
void operate_complx(float n1, float i1, float n2, float i2)
{
    ...
    cout<<"Addition of given complex number is : "<<real(addcomp)<<" + "<<imag(addcomp)<<"i\n";
    temp1 = (n1*n2) - (i1*i2);
    temp2 = (n1*i2) + (i1*n2);
    cout<<"Multiplication of given complex number is : "<<temp1<<" + "<<temp2<<"i\n";
}

void show_complex()
{
    std::complex<int>mycomplex(0,0);
    cout<<"Complex numbers are in the format of : "<<real(mycomplex)<<" + "<<imag(mycomplex)<<"i\n";
}
