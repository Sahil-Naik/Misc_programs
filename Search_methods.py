# Types of Search method included are - Fibbonacci Search, Sentinel Search, Linear Search, Binary Search
# This program perfroms various searching method on the student data given.
# Student data included: Attendance record, Roll number, Student Names.

import names
import random

# Initialized empty lists to store their respective values later in the code.
stu_names = []
stu_roll = []
stu_att = []

# Variable 'exit' and 'exile' both stores the condition of exiting for different stage of code.
exit = False
exile = False
options = ['absent', 'present'] # This list randomly assigns students as 'Absent' or 'Present'
quote = ['Hooray!', 'We did it!', 'Not bad!', 'Getting Serious?', 'No shaddy business.'] # Just used to show random quotes on every run.
...
# Run program until prompted to exit by the user
while exit != True:
    ...
    if chc == 1:
        ...
        while exile != True:
            ...
            # Variable 'huh' stores the name of student who's record is going to be checked
            huh = input("Enter the name of student : ").capitalize()
            
            # Variable 'ch1' stores user's choice for searching
            ch1 = int(input("Search using :\n1 = Linear Search\n2 = Sentinel Search\n3 = Binary Search\n4 = Fibonacci Search\n5 = Head back\nEnter your Choice : "))
            
            # Accept Search method from user and continue
